...
\begin{figure}[ht]
  ...
  \begin{BVerbatim}
    ...
    │   │   ├── [dir]
    │   │   │   └── __init__.py
    │   │   ├── color-embeddings.ipynb
    │   │   ├── content_expansion.py
    │   │   ├── costs.py
    │   │   ├── embedding_cache.py
    │   │   ├── feature.py
    │   │   ├── file.py
    │   │   ├── historical_transfer.py
    │   │   ├── train.py
    │   │   └── tree_metric.py
    │   ├── cluster.py
    │   ├── cluster_react.ipynb
