...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{output/metric_and_dimensionality_short_term.pdf}
  \caption{TODO} % TODO
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{output/metric_and_dimensionality_long_term.pdf}
  \caption{TODO} % TODO
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{output/expansion_model.pdf}
  \caption{TODO} % TODO
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.7\textwidth]{output/content_expansion.pdf}
  \caption{TODO} % TODO
